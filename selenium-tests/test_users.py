...
def fill_out_signup_form(selenium, username="username12345", email="email@gmail.com", 
                            password="p@$$w0rd12345", confirm="p@$$w0rd12345"):
    """
    ...
    selenium.find_element(By.XPATH, '//*[@id="signup-box"]/form/input[6]').click()

def fill_out_login_form(selenium, username, password):
    """
    Helper for filling out login form
    """
    selenium.find_element(By.XPATH, '//*[@id="login-box"]/form/input[1]').send_keys(username)
    selenium.find_element(By.XPATH, '//*[@id="login-box"]/form/input[2]').send_keys(password)
...
def test_invalid_signup(selenium, test_server_url, test_user, test_password):
    ...
    email_err = selenium.find_element(By.XPATH, '//*[@id="signup-box"]/form/p[1]')
    pass_err = selenium.find_element(By.XPATH, '//*[@id="signup-box"]/form/p[2]')
...
def test_valid_signup(selenium, test_server_url):
    ...
    # ensure that an attempted login will result in the email verification sent page
    selenium.get(test_server_url + "/login")
